...
module.exports = async ({
    ...
    // Define the RoseCurveNFT smart contract parameters
    contract = {
        name: 'RoseCurveNFT',
...
async function mint(log, chainId, linkTokenAddress, fee, contract, contractAddress, contractName, signer) {
    ...
    finishMint_tx = await contract.finishMint(
        tokenId, ["#44ffcc", "#bb7722", "#77bbee", "#9988cc", "#ff5566"], { gasLimit: 2_000_000 })
